...
gulp.task("vendorsCss", function () {
  return (
    gulp
      .src(vendorsCssFiles, { base: "src/assets/css" })
...
var myjsfiles = [
  ...
  // "src/assets/js/__rangeSlider.js",
...
gulp.task("watch", function () {
  gulp.watch("src/assets/less/*.less*", gulp.series("less")).on("uplink", function (filepath) {
